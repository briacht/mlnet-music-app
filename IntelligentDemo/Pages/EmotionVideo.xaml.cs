...
namespace IntelligentDemo.Pages
{
    ...
    {
        private Dictionary<string, IEnumerable<NoteCommand>> _bassLines = new Dictionary<string, IEnumerable<NoteCommand>>();

        public EmotionVideo()
        {
            this.InitializeComponent();

            _bassLines["Anger"] = new List<NoteCommand>
            {
                new NoteCommand{ Note = 36, Duration = 16, Velocity = 127, Position = 1},
            };

            _bassLines["Contempt"] = new List<NoteCommand>
            {
            ...
            _bassLines["Disgust"] = new List<NoteCommand>
            {
            ...
            _bassLines["Fear"] = new List<NoteCommand>
            {
            ...
            _bassLines["Happiness"] = new List<NoteCommand>
            {
